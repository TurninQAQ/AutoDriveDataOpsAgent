...
- Current system facts must come from TOOL_OBSERVATIONS. Knowledge returned by search_knowledge is normalized into RETRIEVED_KNOWLEDGE as static evidence; it explains rules but is not current state.
