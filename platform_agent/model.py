...
- V0.8 keeps all writes guarded; in V1.7 only resume_task may be authorized by a deterministic AUTO policy, while other writes remain HITL-only. The model never selects AUTO.
