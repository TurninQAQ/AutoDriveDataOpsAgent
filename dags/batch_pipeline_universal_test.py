...
with DAG(
    dag_id="batch_pipeline_universal_test",
    schedule=None,
    catchup=False,
    max_active_runs=5,
    params={
    ...
    run_parser >> validate_parser >> run_segment >> validate_segment >> run_map >> validate_map >> run_od >> validate_od >> run_coloration >> validate_coloration >> run_occ >> validate_occ
