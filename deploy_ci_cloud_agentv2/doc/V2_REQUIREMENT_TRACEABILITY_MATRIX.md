...
|---|---|---|
| Real Qwen chat/Agent Provider request | `PARTIAL / EXTERNAL_PROVIDER_UNSTABLE` | Strict json_schema mode with qwen3.7-plus-2026-05-26 produced a valid first decision and fresh single-READ CompletionGate pass; a fresh batch produced three normalized READs but the follow-up model turn timed out; bounded sample was 1/5 completed, 0 schema-invalid, 4 provider-unavailable, WRITE=0 |
